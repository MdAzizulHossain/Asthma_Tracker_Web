...
class Label(Widget):
    ...
    _attrMap = AttrMap(
        ...
        customDrawChanger=AttrMapValue(isNoneOrCallable,
                                       ...
                                       _advancedUsage=1),
        ddf=AttrMapValue(NoneOr(isSubclassOf(DirectDraw), 'NoneOrDirectDraw'), desc="A DirectDrawFlowable instance",
                         _advancedUsage=1),
        ddfKlass=AttrMapValue(NoneOr(isSubclassOf(Flowable), 'NoneOrDirectDraw'), desc="A DirectDrawFlowable instance",
                              _advancedUsage=1),
        ddfStyle=AttrMapValue(NoneOr(isSubclassOf(PropertySet)), desc="A style for a ddfKlass or None",
                              _advancedUsage=1),
    )
