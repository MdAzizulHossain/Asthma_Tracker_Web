...
class Doughnut(AbstractPieChart):
    _attrMap = AttrMap(
        ...
        data=AttrMapValue(EitherOr((isListOfNoneOrNumber, isListOfListOfNoneOrNumber)),
                ...
                if shader:
                    ...
                    if nshades > 1:
                        ...
                        for ish in xrange(nshades):
                            ...
                            shc = shader(shsc, shf1 + dsh * ish)
                            if n > 1:
                                shSector = Wedge(cx, cy, xradius, sha1, sha2, yradius=yradius, radius1=xir,
                                                 yradius1=yir)
                            elif n == 1:
                                shSector = Wedge(cx, cy, xradius, sha1, sha2, yradius=yradius, radius1=xir,
                                                 yradius1=yir, annular=True)
                            shSector.fillColor = shc
                            shSector.strokeColor = None
                            shSector.strokeWidth = 0
                            g.add(shSector)
