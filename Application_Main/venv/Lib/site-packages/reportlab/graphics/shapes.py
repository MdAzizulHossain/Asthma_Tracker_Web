...
class Drawing(Group, Flowable):
    ...
    def asString(self, format, verbose=None, preview=0, **kw):
        ...
        if format == 'pdf':
            ...
            from reportlab.graphics import renderSVG
            return renderSVG.drawToString(self, showBoundary=getattr(self, 'showBorder', rl_config.showBoundary),
                                          **_extraKW(self, '_renderSVG_', **kw))
...
class Hatching(Path):
    ...
    _attrMap = AttrMap(BASE=Path,
                       ...
                       angles=AttrMapValue(EitherOr((isNumber, isListOfNumbers, "angle(s)")),
                                           desc="the angle or list of angles at which hatching lines should be drawn"),
                       spacings=AttrMapValue(EitherOr((isNumber, isListOfNumbers, "spacings(s)")),
