...
class CandleStickProperties(PropHolder):
    ...
    def __call__(self, _x, _y, _size, _color):
        ...
        if haveBox:
            ...
            if candleKind != 'vertical':
                x, y, w, h = y, x, h, w
            G(shapes.Rect(x, y, w, h, strokeColor=boxStrokeColor if self.boxSides else None, strokeWidth=boxStrokeWidth,
                          strokeDashArray=boxStrokeDashArray, fillColor=boxFillColor))
